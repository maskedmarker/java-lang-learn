 ...
 * 2. 字段赋值也不通过setter方法
 */
public class SerializationPerson1Test {

    private static final String FILE_NAME_SUFFIX = "ser";

    @Test
    public void testSerialization() throws IOException {
        SerializationPerson1 person = new SerializationPerson1();
        person.setId(1024);
        person.setName("zhangsan");
        System.out.println("person = " + person);

        String objectFileName = SerializationPerson1.class.getSimpleName() + FILE_NAME_SUFFIX;
    ...
    public void testDeserialization() throws IOException, ClassNotFoundException {
        ...
        SerializationPerson1 person = (SerializationPerson1) ois.readObject();
        System.out.println("person = " + person);
    }
}