 ...
 * @author cjh
 */
public class StringMaskOperationDemo {

    public static void main(String[] args) {
        String rawString = "0123456789a";
        String maskString = "******************************";
        StringMaskOperationDemo demo = new StringMaskOperationDemo();
        String maskedString = demo.doMaskString(rawString, 11, maskString);
